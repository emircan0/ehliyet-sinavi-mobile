...
export default function PrivacyScreen() {
    ...
    const content = {
        tr: {
            ...
            s5_c: "Verilerinizin kontrolü tamamen sizin elinizdedir. Premiumfil ayarlarınız üzerinden 'Hesabımı Sil' seçeneğini kullanarak sistemimizde kayıtlı olan tüm dijital ayak izinizi ve hesap bilgilerinizi kalıcı olarak yok edebilirsiniz. KVKK kapsamında sahip olduğunuz haklar, bilgi düzeltme veya verilerinize erişim gibi konular için dilediğiniz her an bizimle doğrudan iletişime geçebilirsiniz.",
