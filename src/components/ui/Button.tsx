...
export const Button = ({
    ...
    const variants = {
        ...
        outline: "border-[1px] border-slate-200 bg-white active:bg-slate-50",

        // Tamamen şeffaf, sadece metin odaklı
        ghost: "bg-transparent active:bg-slate-100/50",

        // Gelir modeli için: Siyah/Lacivert lüks görünüm
        premium: "bg-slate-900 active:bg-black shadow-lg shadow-slate-900/20",
    };
